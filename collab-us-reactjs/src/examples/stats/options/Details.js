...
import styles from 'resources/css/examples/stats/options/Details.module.css';

function StatDetailsOptions(props)
{
    const { url } = props.match;
    const { stat_id } = props.match.params;

    const [callDelete, qDelete] = useDelete(queries.DELETE_STAT,
    {
      onCompleted: data =>
      {
...
export default StatDetailsOptions;
